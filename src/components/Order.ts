...
export class Order extends Form<IOrderForm> {
    ...
    constructor(events: EventEmitter, container: HTMLFormElement) {
        ...
        this._paymentOnline = ensureElement<HTMLButtonElement>('.button_alt[name=card]' , container);
        this._paymentPersonally = ensureElement<HTMLButtonElement>('.button_alt[name=cash]' , container);
    ...
    set payment(value: PaymentType) {
        this._paymentOnline.classList.toggle('button_alt-active', value === 'online');
        this._paymentPersonally.classList.toggle('button_alt-active', value === 'personally');
    }
