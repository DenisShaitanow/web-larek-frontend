...
larek.view.addModalWindowContainer<HTMLDivElement>('#modal-container');
larek.view.addAppendPlace('gallery', 'gallery');
larek.view.addAppendPlace<HTMLDivElement>('modalContent' , 'modal__content', larek.view.modalWindow);
larek.view.addAppendPlace<HTMLUListElement>('basket' , 'basket__list', cloneTemplate(larek.view.templateBusket));
larek.renderProductList();
larek.view.openBusketListener();
